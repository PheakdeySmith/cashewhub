            ...
            <div class="topbar-item d-none d-md-flex">
                <div class="dropdown">
                    <a href="https://coderthemes.com/boron/layouts/tables-gridjs.html"
                        ...
                        data-bs-toggle="dropdown" data-bs-trigger="hover" data-bs-offset="0,24"
                            ...
                            <div class="col-md-4">
                                <div class="p-3">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/tables-gridjs.html#!">Widgets</a>
                                        </li>
                                        <li>
                                            <a
                                        ...
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/extended-sweetalerts.html">Sweet
                                                Alerts</a>
                                        </li>
                                        <li>
                                            <a
                                        ...
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/form-range-slider.html">Range
                                                Slider</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="p-3">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/apps-email.html">Email</a>
                                        </li>
                                        <li>
                                            <a
                                        ...
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/tables-gridjs.html#!">Kanban
                                                Board</a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-md-4 bg-light bg-opacity-50">
                                <div class="p-3">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a
                                                href="https://coderthemes.com/boron/layouts/pages-coming-soon.html">Maintenance
                                                &amp; Coming Soon</a>
                                        </li>
                                    </ul>
                                </div> <!-- end .bg-light-->
                                            ...
                                            <div class="simplebar-content" style="padding: 0px;">
                                                ...
                                                <div class="dropdown-item notification-item py-2 text-wrap active"
                                                    ...
                                                    <span class="d-flex align-items-center">
                                                        ...
                                                        <span class="flex-grow-1 text-muted">
                                                            ...
                                                            commented on <span
                                                                class="fw-medium text-body">paces admin
                                                                status</span>
                                                            <br>
                                                ...
                                                <div class="dropdown-item notification-item py-2 text-wrap"
                                                    ...
                                                    <span class="d-flex align-items-center">
                                                        ...
                                                        <span class="flex-grow-1 text-muted">
                                                            You withdraw a <span
                                                                class="fw-medium text-body">$500</span> by
