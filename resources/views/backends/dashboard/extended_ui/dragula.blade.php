...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Dragula</h4>
        </div>
                            ...
                            <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                ...
                                <div id="company-list-left" class="py-2">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-1.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-2.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-3.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                ...
                                <div id="company-list-right" class="py-2">
                                    <div class="card mb-0 mt-2">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-4.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-5.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-start">
                                                <img src="{{ asset('assets') }}/images/avatar-6.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                            ...
                            <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                ...
                                <div id="handle-dragula-left" class="py-2">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets') }}/images/avatar-7.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets') }}/images/avatar-8.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="card mb-0 mt-2">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets') }}/images/avatar-9.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
                            ...
                            <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                ...
                                <div id="handle-dragula-right" class="py-2">
                                    <div class="card mb-0 mt-2">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets') }}/images/avatar-10.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                <div class="w-100 overflow-hidden">
...
@push('script')
    ...
    <script src="{{ asset('assets') }}/js/extended-dragula.js"></script>
@endpush
