...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Utilities</h4>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex flex-column gap-2">
                                <div class="bg-primary-subtle p-2"><code class="text-primary-emphasis">.bg-primary-subtle</code>
                                </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-primary">Primary link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-secondary">Secondary link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-success">Success link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-danger">Danger link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-warning">Warning link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-info">Info link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-light">Light link</a>
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="link-dark">Dark link</a>
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded" alt="rounded">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded-top" alt="rounded-top">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded-end" alt="rounded-end">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded-bottom" alt="rounded-bottom">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded-start" alt="rounded-start">
                        <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="avatar-lg rounded-circle" alt="rounded-circle">
                        <img src="{{ asset('assets') }}/images/small-2.jpg" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-0" alt="rounded-0">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-1" alt="rounded-1">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-2" alt="rounded-2">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-3" alt="rounded-3">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-4" alt="rounded-4">
                        <img src="{{ asset('assets') }}/images/avatar-4.jpg" class="avatar-lg rounded-5" alt="rounded-5">
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
        </div> <!-- end col -->
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="pe-none" tabindex="-1" aria-disabled="true">This link</a>
                        can not be clicked.</p>
                    <p><a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="pe-auto">This link</a> can be clicked (this is default
                        behavior).</p>
                    <p class="pe-none"><a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" tabindex="-1" aria-disabled="true">This link</a>
                        can not be clicked because the
                        <code>pointer-events</code> property is inherited from its parent. However,
                        <a href="https://coderthemes.com/boron/layouts/ui-utilities.html#" class="pe-auto">this
