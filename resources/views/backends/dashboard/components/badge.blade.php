...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Badges</h4>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4>h4.Example heading <a href="https://coderthemes.com/boron/layouts/ui-badges.html#" class="badge badge-soft-info">Info Link</a></h4>
