...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Modals</h4>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="bs-example-modal-sm" tabindex="-1" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
                    ...
                    <div id="full-width-modal" class="modal fade" tabindex="-1" aria-labelledby="fullWidthModalLabel" style="display: none;" aria-hidden="true">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="auth-brand text-center mt-2 mb-4 position-relative top-0">
                                        <a href="https://coderthemes.com/boron/layouts/index.html" class="logo-dark">
                                            <span><img src="{{ asset('assets') }}/images/logo-dark.png" alt="dark logo" height="22"></span>
                                        </a>
                                        <a href="https://coderthemes.com/boron/layouts/index.html" class="logo-light">
                                            <span><img src="{{ asset('assets') }}/images/logo.png" alt="logo" height="22"></span>
                                        </a>
                                    </div>

                                    <form class="ps-3 pe-3" action="https://coderthemes.com/boron/layouts/ui-modals.html#">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="customCheck1">I accept <a href="https://coderthemes.com/boron/layouts/ui-modals.html#">Terms and Conditions</a></label>
                                            </div>
                                        </div>
                    ...
                    <div id="login-modal" class="modal fade" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="auth-brand text-center mt-2 mb-4 position-relative top-0">
                                    ...
                                    <form action="https://coderthemes.com/boron/layouts/ui-modals.html#" class="ps-3 pe-3">
                                        <div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">A rendered modal with header, body and footer having contexual background color.</p>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-secondary" data-bs-toggle="modal" href="https://coderthemes.com/boron/layouts/ui-modals.html#exampleModalToggle" role="button">Open First Modal</a>
