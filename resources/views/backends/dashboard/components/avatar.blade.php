...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Avatars</h4>
        </div>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('assets') }}/images/avatar-2.jpg" alt="image" class="img-fluid avatar-xs rounded">
                            <p>
                                <code>.avatar-xs</code>
                            </p>
                            <img src="{{ asset('assets') }}/images/avatar-3.jpg" alt="image" class="img-fluid avatar-sm rounded mt-2">
                            <p class="mb-2 mb-sm-0">
                                <code>.avatar-sm</code>
                            </p>
                        </div>
                        <div class="col-md-3">
                            <img src="{{ asset('assets') }}/images/avatar-4.jpg" alt="image" class="img-fluid avatar-md rounded">
                            <p>
                                <code>.avatar-md</code>
                            </p>
                        </div>
                        ...
                        <div class="col-md-3">
                            <img src="{{ asset('assets') }}/images/avatar-5.jpg" alt="image" class="img-fluid avatar-lg rounded">
                            <p>
                                <code>.avatar-lg</code>
                            </p>
                        </div>
                        ...
                        <div class="col-md-3">
                            <img src="{{ asset('assets') }}/images/avatar-6.jpg" alt="image" class="img-fluid avatar-xl rounded">
                            <p class="mb-0">
                                <code>.avatar-xl</code>
                            </p>
                        </div>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('assets') }}/images/avatar-7.jpg" alt="image" class="img-fluid avatar-md rounded-circle">
                            <p class="mt-1">
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('assets') }}/images/avatar-8.jpg" alt="image" class="img-fluid avatar-lg rounded-circle">
                            <p>
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('assets') }}/images/avatar-9.jpg" alt="image" class="img-fluid avatar-xl rounded-circle">
                            <p class="mb-0">
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            ...
                            <div class="avatar-group">
                                ...
                                <div class="avatar">
                                    <img src="{{ asset('assets') }}/images/avatar-3.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                                <div class="avatar">
                                    <img src="{{ asset('assets') }}/images/avatar-8.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                                <div class="avatar">
                                    <img src="{{ asset('assets') }}/images/avatar-2.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                            </div>
                        </div> <!-- end col-->
                        <div class="col-xl-3">
                        ...
                        <div class="col-xl-3">
                            <!-- Default Group (Soft) -->
                            <div class="avatar-group">
                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" aria-label="Vicki" data-bs-original-title="Vicki">
                                    <img src="{{ asset('assets') }}/images/avatar-10.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                                <div class="avatar avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Thomas">
                                    <span class="avatar-title bg-dark rounded-circle fw-bold">
                                        T
                                    </span>
                                </div>
                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-warning" data-bs-placement="top" aria-label="Kevin" data-bs-original-title="Kevin">
                                    <img src="{{ asset('assets') }}/images/avatar-7.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-info" data-bs-placement="top" aria-label="Chris" data-bs-original-title="Chris">
                                    <img src="{{ asset('assets') }}/images/avatar-1.jpg" alt="" class="rounded-circle avatar-sm">
                                </div>
                                <div class="avatar avatar-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-danger" data-bs-placement="top" data-bs-original-title="15 more Users">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <img src="{{ asset('assets') }}/images/small-2.jpg" alt="image" class="img-fluid rounded" width="200">
                            <p class="mb-0">
                                <code>.rounded</code>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-2 text-center">
                            <img src="{{ asset('assets') }}/images/avatar-2.jpg" alt="image" class="img-fluid rounded" width="120">
                            <p class="mb-0">
                                <code>.rounded</code>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-2 text-center">
                            <img src="{{ asset('assets') }}/images/avatar-7.jpg" alt="image" class="img-fluid rounded-circle" width="120">
                            <p class="mb-0">
                        ...
                        <div class="col-sm-2">
                            <img src="{{ asset('assets') }}/images/small-1.jpg" alt="image" class="img-fluid img-thumbnail" width="200">
                            <p class="mb-0">
                                <code>.img-thumbnail</code>
                            </p>
                        </div>
                        <div class="col-sm-2">
                            <img src="{{ asset('assets') }}/images/avatar-8.jpg" alt="image" class="img-fluid rounded-circle img-thumbnail" width="120">
                            <p class="mb-0">
