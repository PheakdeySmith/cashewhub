...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Scrollspy</h4>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                <a class="navbar-brand" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#">Navbar</a>
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#fat">@fat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#mdo">@mdo</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <i class="ti ti-chevron-down"></i></a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#one">one</a>
                            <a class="dropdown-item" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#two">two</a>
                            <div role="separator" class="dropdown-divider"></div>
                            <a class="dropdown-item" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#three">three</a>
                        </div>
                    </li>
                </ul>
            </nav>
                ...
                <div class="col-2">
                    <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link active" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-1">Item 1</a>
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link ms-3 my-1" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-1-1">Item 1-1</a>
                                <a class="nav-link ms-3 my-1" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-1-2">Item 1-2</a>
                            </nav>
                            <a class="nav-link" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-2">Item 2</a>
                            <a class="nav-link" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-3">Item 3</a>
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link ms-3 my-1" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-3-1">Item 3-1</a>
                                <a class="nav-link ms-3 my-1" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#item-3-2">Item 3-2</a>
                            </nav>
                        </nav>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-2">
                    <div id="list-example" class="list-group">
                        <a class="list-group-item list-group-item-action active" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#list-item-1">Item 1</a>
                        <a class="list-group-item list-group-item-action" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#list-item-2">Item 2</a>
                        <a class="list-group-item list-group-item-action" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#list-item-3">Item 3</a>
                        <a class="list-group-item list-group-item-action" href="https://coderthemes.com/boron/layouts/ui-scrollspy.html#list-item-4">Item 4</a>
                    </div>
                </div>
                <div class="col-10">
