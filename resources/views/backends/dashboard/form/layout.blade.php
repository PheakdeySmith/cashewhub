    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 text-uppercase fw-bold mb-0">Form Layouts</h4>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Create horizontal forms with the grid by adding the <code>.row</code> class to
                            ...
                            controls. Be sure to add <code>.col-form-label</code> to your <code>&lt;label&gt;</code>s as
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Use the <code>.row-cols-lg-auto</code>, <code>.g-3</code> &amp; <code>.align-items-center</code>
                            class to display a series of labels, form controls, and buttons on a single horizontal row. Form
                            controls within inline forms vary slightly from their default states. Controls only appear
                            inline in viewports that are at least 576px wide to account for narrow viewports on mobile
                            devices.
                        </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Be sure to use <code>.col-form-label-sm</code> or
                            ...
                            <code>&lt;legend&gt;</code>s to correctly follow the size of <code>.form-control-lg</code> and
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            By adding <code>.row</code> &amp; <code>.g-2</code>, you can have control over the gutter width
