...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Collapse</h4>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <a class="btn btn-primary" data-bs-toggle="collapse" href="https://coderthemes.com/boron/layouts/ui-collapse.html#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                            Link with href
                        </a>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <a class="btn btn-primary" data-bs-toggle="collapse" href="https://coderthemes.com/boron/layouts/ui-collapse.html#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Toggle first element</a>
