...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Offcanvas</h4>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a class="btn btn-primary" data-bs-toggle="offcanvas" href="https://coderthemes.com/boron/layouts/ui-offcanvas.html#offcanvasExample" role="button" aria-controls="offcanvasExample">
                            Link with href
                        </a>
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Change the appearance of offcanvases with utilities to better match them to different contexts like dark navbars.
