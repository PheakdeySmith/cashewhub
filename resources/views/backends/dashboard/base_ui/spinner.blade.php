...
<div class="page-container">
    ...
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 text-uppercase fw-bold mb-0">Spinners</h4>
        </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use flexbox utilities, float utilities, or text alignment utilities to place spinners exactly where you need them in any situation.</p>
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>flexbox utilities</code>, <code>float utilities</code>, or <code>text alignment</code> utilities to place spinners exactly where you need them in any situation.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use spinners within buttons to indicate an action is currently processing or taking place.
