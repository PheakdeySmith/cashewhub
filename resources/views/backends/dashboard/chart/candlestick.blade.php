        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="simple-candlestick" class="apex-charts" data-colors="#6ac75a,#fa5c7c" style="min-height: 415px;"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="combo-candlestick" class="apex-charts" data-colors="#6ac75a,#fa5c7c" style="min-height: 255px;">

                        </div>
                        <div id="combo-bar-candlestick" class="apex-charts" data-colors="#ce7e7e,#ffbc00" style="min-height: 175px;"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="candlestick-with-line" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c" style="min-height: 395px;">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
...
<script src="{{ asset('assets') }}/js/chart-apex-candlestick.js"></script>
