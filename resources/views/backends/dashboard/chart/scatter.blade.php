    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 text-uppercase fw-bold mb-0">Scatter Charts</h4>
            </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div dir="ltr">
                            <div id="basic-scatter" class="apex-charts" data-colors="#39afd1,#ffbc00,#ce7e7e"
                    ...
                    <div class="card-body">
                        ...
                        <div dir="ltr">
                            <div id="datetime-scatter" class="apex-charts"
                                data-colors="#6c757d,#ffbc00,#ce7e7e,#6ac75a,#fa5c7c" style="min-height: 395px;">
                            </div>
                        </div>
                    </div>
                    <!-- end card body-->
...
@push('script')
    ...
    <script src="{{ asset('assets') }}/js/chart-apex-scatter.js"></script><svg id="SvgjsSvg1006" width="2" height="0" xmlns="http://www.w3.org/2000/svg"
