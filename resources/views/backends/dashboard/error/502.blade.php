        ...
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <div class="mx-auto text-center">
                    <img src="{{ asset('assets') }}/images/error-502.png" alt="error 502 img" height="280">
                    <h3 class="fw-bold mt-3 text-primary lh-base">Service Overloaded !</h3>
                    <h4 class="mt-2 text-dark lh-base">Server error. Please refresh Or Try again later.</h4>
