        ...
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <div class="mx-auto text-center">
                    <img src="{{ asset('assets') }}/images/error-500.png" alt="error 500 img" height="230" class="my-3">
                    <h3 class="fw-bold mt-3 text-primary lh-base">Server Error</h3>
                    <h4 class="mt-2 text-dark lh-base">Ohh Noo ! Seem like our servers are lost</h4>
                    <p class="text-muted fs-12 mb-3">Our internal server has gone on a uninformed vacation. And, we are trying our best to bring it back online.</p>
