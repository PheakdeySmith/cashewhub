        ...
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <div class="mx-auto text-center">
                    <img src="{{ asset('assets') }}/images/error-400.png" alt="error 400 img" height="230">

                    <h2 class="fw-bold mt-3 text-primary lh-base">Bed Request ! </h2>
                    <h4 class="mt-2 text-dark lh-base">Your browser sent an invalid request</h4>
                    <p class="text-muted fs-12 mb-3">The server could not understand the request due to invalid syntax. Please check your input and try again.</p>
