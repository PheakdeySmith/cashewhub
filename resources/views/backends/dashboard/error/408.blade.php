        ...
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <div class="mx-auto text-center">
                    <img src="{{ asset('assets') }}/images/error-408.png" alt="error 408 img" height="230">
                    <h3 class="fw-bold mt-3 text-primary lh-base">Error 408 Request Time Out</h3>
                    <h5 class="mt-2 text-dark lh-base">The server timed out waiting for the client's request.</h5>
